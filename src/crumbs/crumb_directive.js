...
(function (){
    ...
    angular.module('crumbs').directive('crumbSelector', selectorPillComponent);
       ...
       var p_Ctrl = this;
        ...
        function add_init_Crumb (){
            if(p_Ctrl.WeaveService.request_WeaveTree()){
                ...
                scope.$apply();//because digest completes by the time the tree root is fetched//TODO replace all setTimeouts with $timeout
            }
            else
